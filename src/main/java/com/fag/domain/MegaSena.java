...
public class MegaSena {
    ...
    public BigDecimal getAcumuladoSorteioEspecialMegaVirada() {
        return acumuladoSorteioEspecialMegaVirada;
    }

    public void setAcumuladoSorteioEspecialMegaVirada(BigDecimal acumuladoSorteioEspecialMegaVirada) {
        this.acumuladoSorteioEspecialMegaVirada = acumuladoSorteioEspecialMegaVirada;
    }
